...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="#" class="logo" style="background-color: #0575E6">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img class="mr-3" src="<?= base_url().'assets/template/img/bemft/bemft.png' ?>" width="40px"> BEM FT</span>
    </a>

    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top" style="background-color: #0575E6">
