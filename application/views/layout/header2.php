  ...
  <link href="<?= base_url().'assets/template/css/mystyle2.css" rel="stylesheet' ?>">
...
<body>
  ...
  <!--==========================
    Header
  ============================-->
  <header id="header" style="background-color: #193EDD;">
    <div class="container-fluid">

      <div id="logo" class="pull-left">
        <img style="margin-top: -12px" width="210px" height="50px" src="<?= base_url('').'assets/template/img/bemft/header2.png '?>" alt="" title="" />
      </div>
